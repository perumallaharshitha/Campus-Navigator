...
const DepartmentDetails = () => {
  ...
  // Handle button click and navigate to faculty details for the specific department
  const handleButtonClick = (department) => {
    // Navigate to the department-specific faculty details page
    navigate(`/department/faculty-details/${encodeURIComponent(department)}`);
  };
      ...
      {cards.map((dept, index) => (
        <div key={index} className="department-card">
          ...
          <div className="details">
            ...
            <button className="details-btn" onClick={() => handleButtonClick(dept.department)}>
              View Details
            </button>
          </div>
        </div>
